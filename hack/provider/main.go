...
var checksumMap = map[string]string{
	"./release/devpod-provider-ecs-linux-amd64":       "##CHECKSUM_LINUX_AMD64##",
	"./release/devpod-provider-ecs-linux-arm64":       "##CHECKSUM_LINUX_ARM64##",
	"./release/devpod-provider-ecs-darwin-amd64":      "##CHECKSUM_DARWIN_AMD64##",
	"./release/devpod-provider-ecs-darwin-arm64":      "##CHECKSUM_DARWIN_ARM64##",
	"./release/devpod-provider-ecs-windows-amd64.exe": "##CHECKSUM_WINDOWS_AMD64##",
}
